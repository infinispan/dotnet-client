...
cmake -G "%full_generator%" -DHOTRODCPP32_HOME=%HOTRODCPP32_HOME% -DHOTRODCPP64_HOME=%HOTRODCPP64_HOME%  -DPROTOBUF_INCLUDE_DIR=%PROTOBUF_INCLUDE_DIR%  -DIKVM_CUSTOM_BIN_PATH=%IKVM_CUSTOM_BIN_PATH% %~4 ..
