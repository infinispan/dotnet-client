...
namespace Infinispan.DotNetClient.Operations
{
    ...
    * 
    */
    public class ReplaceIfUnmodifiedOperation : AbstractKeyValueOperation<VersionedOperationResponse>
    {
        private readonly long version;
        private static Logger logger;

        public ReplaceIfUnmodifiedOperation(Codec codec, byte[] key, byte[] cacheName, int topologyId, Flag[] flags, byte[] value, int lifespan, int maxIdle, long version) :
