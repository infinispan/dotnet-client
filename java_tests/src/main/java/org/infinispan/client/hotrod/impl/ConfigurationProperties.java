...
public class ConfigurationProperties {
   ...
   public String getTransportFactory() {
      return props.getProperty(TRANSPORT_FACTORY, null);
   }
   ...
   public String getAsyncExecutorFactory() {
      return props.getProperty(ASYNC_EXECUTOR_FACTORY, null);
   }
   ...
   public String getRequestBalancingStrategy() {
      return props.getProperty(REQUEST_BALANCING_STRATEGY, null);
   }
