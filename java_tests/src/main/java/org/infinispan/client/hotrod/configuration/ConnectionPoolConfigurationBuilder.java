...
public class ConnectionPoolConfigurationBuilder extends AbstractConfigurationChildBuilder implements Builder<ConnectionPoolConfiguration> {
   ...
   private cli.Infinispan.HotRod.Config.ConnectionPoolConfigurationBuilder jniConnectionPoolConfigurationBuilder;

   public ConnectionPoolConfigurationBuilder(ConfigurationBuilder builder,
         cli.Infinispan.HotRod.Config.ConnectionPoolConfigurationBuilder jniConnectionPoolConfigurationBuilder) {
      super(builder);
      this.jniConnectionPoolConfigurationBuilder = jniConnectionPoolConfigurationBuilder;
   }
   ...
   public ConnectionPoolConfigurationBuilder exhaustedAction(ExhaustedAction exhaustedAction) {
      // this.jniConnectionPoolConfigurationBuilder.ExhaustedAction(exhaustedAction.getJniExhaustedAction());
   ...
   public ConnectionPoolConfigurationBuilder lifo(boolean enabled) {
      this.jniConnectionPoolConfigurationBuilder.Lifo(enabled);
      this.lifo = enabled;
      return this;
   }
   ...
   public ConnectionPoolConfigurationBuilder maxActive(int maxActive) {
      this.jniConnectionPoolConfigurationBuilder.MaxActive(maxActive);
   ...
   public ConnectionPoolConfigurationBuilder maxTotal(int maxTotal) {
      this.jniConnectionPoolConfigurationBuilder.MaxTotal(maxTotal);
   ...
   public ConnectionPoolConfigurationBuilder maxWait(long maxWait) {
      this.jniConnectionPoolConfigurationBuilder.MaxWait((int) maxWait);
   ...
   public ConnectionPoolConfigurationBuilder maxIdle(int maxIdle) {
      this.jniConnectionPoolConfigurationBuilder.MaxIdle(maxIdle);
   ...
   public ConnectionPoolConfigurationBuilder minIdle(int minIdle) {
      this.jniConnectionPoolConfigurationBuilder.MinIdle(minIdle);
   ...
   public ConnectionPoolConfigurationBuilder numTestsPerEvictionRun(int numTestsPerEvictionRun) {
      this.jniConnectionPoolConfigurationBuilder.NumTestsPerEvictionRun(numTestsPerEvictionRun);
   ...
   public ConnectionPoolConfigurationBuilder timeBetweenEvictionRuns(long timeBetweenEvictionRuns) {
      this.jniConnectionPoolConfigurationBuilder.TimeBetweenEvictionRuns((int) timeBetweenEvictionRuns);
   ...
   public ConnectionPoolConfigurationBuilder minEvictableIdleTime(long minEvictableIdleTime) {
      this.jniConnectionPoolConfigurationBuilder.MinEvictableIdleTime((int) minEvictableIdleTime);
   ...
   public ConnectionPoolConfigurationBuilder testOnBorrow(boolean testOnBorrow) {
      this.jniConnectionPoolConfigurationBuilder.TestOnBorrow(testOnBorrow);
   ...
   public ConnectionPoolConfigurationBuilder testOnReturn(boolean testOnReturn) {
      this.jniConnectionPoolConfigurationBuilder.TestOnBorrow(testOnReturn);
   ...
   public ConnectionPoolConfigurationBuilder testWhileIdle(boolean testWhileIdle) {
      this.jniConnectionPoolConfigurationBuilder.TestWhileIdle(testWhileIdle);
