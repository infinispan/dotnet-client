...
3. Running the sample application
   ...
   - open the Microsoft Visual C# 2010 Express the "sample.csproj" project file (File\Open Project) located in the “sample” folder of the infinispan dot-net client distribution
   - run the SampleInfinispanClientApplication located in the Program.cs file
